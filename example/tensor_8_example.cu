...
int main(int argc, char* argv[])
{
    ...
    TensorNTTParameters parameters(log_nttSize, 8);
    ...
    CUDA_EXEC(GPU_TensorNTT_8(d_input, d_output, d_majorMatrix, d_minorMatrix, d_factorTable, parameters.log_nttSize, parameters.modulus, batchSize, parameters.nttSize));
